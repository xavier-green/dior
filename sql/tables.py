...
sale = table("sale_sales", "SALE_", "SA", ["Location", "Zone", "DateNumYYYYMMDD", "Style", "Color", "Size", "Country", "Staff", "Std_RP_WOTax_REF", "Division","Department","Group","Theme", "RG_Quantity", "MD_Quantity"])
