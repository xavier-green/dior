...
item = table("ITEM_ITEM", "ITEM_", "IT", ["Code", "Description", "Year", "SCS_Collection", "Division", "Line", "Family", "Sub_Family", "Theme", "Department", "Group", "Vendor", "Series", "Segment", "Material", "Price_Cat", "Model"])
...
sale = table("sale_sales", "SALE_", "SA", ["Location", "Zone", "DateNumYYYYMMDD", "SCS_Collection", "Style", "Color", "Size", "Family", "Country", "Staff", "RG_Net_Amount_WOTax_REF", "MD_Net_Amount_WOTax_REF", "Division","Department","Group","Theme", "RG_Quantity", "MD_Quantity", "Cust_Nationality", "Unit_Avg_Cost_REF"])
...
stock_daily = table("stoc_stocks_Daily", "STOC_", "DA", ["DateNumYYYYMMDD", "Location", "Date", "Style", "Color", "Size", "Country", "Zone", "Quantity", "Theme", "SCS_Collection", "Division", "Line", "Family", "Sub_Family", "Theme", "Department", "Group",])
...
collection = table("Coll_Collection", "COLL_", "COLL", ["Code", "Description"])
collectiondate = table("Coll_Dates", "COLL_", "COLLD", ["Code", "Sale_date_deb", "Sale_date_fin"])
