...
sale = table("sale_sales", "SALE_", "SA", ["Location", "Zone", "DateNumYYYYMMDD", "Style", "Color", "Size", "Family", "Country", "Staff", "RG_Net_Amount_WOTax_REF", "MD_Net_Amount_WOTax_REF", "Division","Department","Group","Theme", "RG_Quantity", "MD_Quantity", "Cust_Nationality", "Unit_Avg_Cost_REF"])
