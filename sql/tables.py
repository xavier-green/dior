...
stock_daily = table("stoc_stocks_Daily", "STOC_", "DA", ["Location", "Date", "Style", "Color", "Size", "Country", "Zone", "Quantity", "Theme", "Collection", "Division", "Line", "Family", "Sub_Family", "Theme", "Department", "Group",])
